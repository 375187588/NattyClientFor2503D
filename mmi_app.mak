...
SRC_LIST += plutommi\Natty\NattySrc\NattyAbstractClass.c
SRC_LIST += plutommi\Natty\NattySrc\NattyRBTree.c
SRC_LIST += plutommi\Natty\NattySrc\NattyNetwork.c
SRC_LIST += plutommi\Natty\NattySrc\NattyTimer.c
SRC_LIST += plutommi\Natty\NattySrc\NattyClientDev.c
SRC_LIST += plutommi\Natty\NattySrc\NattyUtils.c
SRC_LIST += plutommi\Natty\NattySrc\NattyMain.c
SRC_LIST += plutommi\Natty\NattySrc\NattyWlan.c
SRC_LIST += plutommi\Natty\NattySrc\NattyGPS.c
SRC_LIST += plutommi\Natty\NattySrc\NattyCell.c
SRC_LIST += plutommi\Natty\NattySrc\NattyHttp.c
SRC_LIST += plutommi\Natty\NattySrc\NattyLocation.c
SRC_LIST += plutommi\Natty\NattySrc\NattyUserDataProtocol.c
SRC_LIST += plutommi\mtkapp\EngineerMode\EngineerModeApp\EngineerModeAppSrc\EngineerModeSocketApp.c
endif
endif

ifdef USE_NATTY_SSL
ifeq ($(strip $(USE_NATTY_SSL)),TRUE)
SRC_LIST += plutommi\Natty\NattySrc\ssl\openssl_aes_cfb.c
SRC_LIST += plutommi\Natty\NattySrc\ssl\openssl_aes_core.c
SRC_LIST += plutommi\Natty\NattySrc\ssl\openssl_cbc_enc.c
SRC_LIST += plutommi\Natty\NattySrc\ssl\openssl_cfb128.c
SRC_LIST += plutommi\Natty\NattySrc\ssl\openssl_des_enc.c
SRC_LIST += plutommi\Natty\NattySrc\ssl\openssl_md5.c
SRC_LIST += plutommi\Natty\NattySrc\ssl\openssl_ncbc_enc.c
SRC_LIST += plutommi\Natty\NattySrc\ssl\openssl_sha1.c
SRC_LIST += plutommi\Natty\NattySrc\ssl\openssl_set_key.c
endif
endif
...
ifdef USE_NATTY_PROTOCOL
ifeq ($(strip $(USE_NATTY_PROTOCOL)),TRUE)
INC_DIR += plutommi\Natty\NattyInc
endif
endif
