...
ifdef TDMA_SUPPORT
	ifeq ($(strip $(TDMA_SUPPORT)),TRUE)	
	COMPOBJS += custom\drv\tmda\PAH8002\libpah8002_mtk2503.a
	endif
endif
...
HORIZONTAL_CAMERA_SUPPORT_SIZE = 128X128 128X160 176X220 240X240 240X320 240X400 320X480 360X640 480X800
